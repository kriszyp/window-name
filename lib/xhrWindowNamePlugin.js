require.def("xhrWindowNamePlugin",["dojo", "dojox/io/xhrPlugins", "./windowName", "dojox/secure/json"], function(dojo.xhrPlugins, windowName, json){

return function(/*String*/url, /*Function?*/httpAdapter, /*Boolean?*/trusted){
	// summary:
